  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-950 via-red-950 via-orange-950 to-black"></div>
        <div className="absolute inset-0 bg-gradient-to-tr from-orange-950/30 via-transparent to-red-950/30"></div>
        
        {/* Animated gradient orbs */}
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] bg-gradient-radial from-red-500/20 via-orange-600/10 to-transparent rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-gradient-radial from-orange-500/25 via-yellow-600/15 to-transparent rounded-full blur-2xl animate-float-slow"></div>
        <div className="absolute top-1/2 left-1/4 w-[400px] h-[400px] bg-gradient-radial from-amber-500/15 via-red-600/10 to-transparent rounded-full blur-3xl animate-float-reverse"></div>
        ...
        {[...Array(80)].map((_, i) => (
          <div
            ...
            className={`absolute rounded-full animate-twinkle ${
              i % 4 === 0 ? 'w-1.5 h-1.5 bg-orange-300' :
              i % 4 === 1 ? 'w-1 h-1 bg-red-300' :
              i % 4 === 2 ? 'w-0.5 h-0.5 bg-amber-300' :
              'w-1 h-1 bg-white'
            }`}
            style={{
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0" style={{
            backgroundImage: `
              ...
              linear-gradient(rgba(245, 101, 101, 0.2) 1px, transparent 1px),
              linear-gradient(90deg, rgba(245, 101, 101, 0.2) 1px, transparent 1px)
            `,
        ...
        <div className="absolute top-1/4 right-1/4 w-8 h-8 border-2 border-orange-400/50 rotate-45 animate-spin-slow"></div>
        <div className="absolute bottom-1/3 left-1/5 w-6 h-6 border-2 border-red-400/50 animate-spin-reverse"></div>
        <div className="absolute top-2/3 right-1/5 w-4 h-8 bg-gradient-to-t from-red-500/30 to-orange-500/30 animate-float-fast"></div>
      </div>
      
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-xl border-b border-red-500/20">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 to-red-500 rounded-xl blur-lg opacity-50 animate-pulse"></div>
              </div>
              <div className="text-2xl font-bold bg-gradient-to-r from-orange-400 via-red-400 to-amber-400 bg-clip-text text-transparent">
                Shrimay
              </div>
            </div>
                ...
                <button
                  ...
                  className={`text-sm font-medium transition-all duration-300 hover:scale-105 relative ${
                    activeSection === item.id 
                      ? 'text-orange-400 after:absolute after:bottom-[-8px] after:left-1/2 after:transform after:-translate-x-1/2 after:w-1 after:h-1 after:bg-orange-400 after:rounded-full' 
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in-up">
              <div className="space-y-6">
                <div className="inline-flex items-center space-x-2 bg-red-500/10 border border-red-500/20 rounded-full px-6 py-3 backdrop-blur-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button 
                  className="group relative bg-gradient-to-r from-orange-500 via-red-500 to-amber-500 hover:from-orange-600 hover:via-red-600 hover:to-amber-600 text-white px-8 py-4 text-lg font-medium rounded-2xl hover:scale-105 transition-all duration-300"
                  onClick={() => scrollToSection('contact')}
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 to-red-400/20 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-300"></div>
                ...
                <Button 
                  variant="outline" 
                  className="border-2 border-red-500/50 text-red-300 hover:bg-red-500/10 px-8 py-4 text-lg font-medium rounded-2xl hover:scale-105 transition-all duration-300 backdrop-blur-sm"
                >
              ...
              <div className="flex space-x-6">
                <a 
                  ...
                  className="group relative w-14 h-14 bg-gradient-to-r from-orange-500/20 to-amber-500/20 border border-orange-500/30 rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 backdrop-blur-sm"
                >
                  <Linkedin className="w-6 h-6 text-orange-400 group-hover:text-white transition-colors" />
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-400/20 to-amber-400/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </a>
                <a 
                  href="#"
                  className="group relative w-14 h-14 bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 rounded-2xl flex items-center justify-center hover:scale-110 transition-all duration-300 backdrop-blur-sm"
                >
                  <Github className="w-6 h-6 text-red-400 group-hover:text-white transition-colors" />
                  <div className="absolute inset-0 bg-gradient-to-r from-red-400/20 to-orange-400/20 rounded-2xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
                </a>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-center animate-fade-in-up delay-200">
              ...
              <div className="relative">
                {/* Outer rotating ring */}
                <div className="absolute inset-0 w-96 h-96 border border-red-500/30 rounded-full animate-spin-slow"></div>
                
                {/* Middle rotating ring */}
                <div className="absolute inset-8 w-80 h-80 border border-orange-500/20 rounded-full animate-spin-reverse"></div>
                
                {/* Inner glowing circle */}
                <div className="relative w-72 h-72 bg-gradient-to-br from-orange-400/20 via-red-500/30 to-amber-500/20 rounded-full backdrop-blur-sm border border-red-500/40 flex items-center justify-center">
                  
                  {/* Profile Image Container */}
                  <div className="w-48 h-48 bg-gradient-to-br from-orange-400 via-red-500 to-amber-500 rounded-full p-1 animate-glow-pulse">
                    <div className="w-full h-full rounded-full bg-black flex items-center justify-center overflow-hidden border border-red-500/50">
                      <img 
                  ...
                  {/* Floating Tech Icons */}
                  <div className="absolute top-4 right-8 w-12 h-12 bg-gradient-to-r from-orange-400 to-amber-500 rounded-2xl flex items-center justify-center animate-orbit-1">
                    <Code className="w-6 h-6 text-white" />
                  </div>
                  <div className="absolute bottom-8 left-4 w-12 h-12 bg-gradient-to-r from-red-400 to-orange-500 rounded-2xl flex items-center justify-center animate-orbit-2">
                    <Terminal className="w-6 h-6 text-white" />
                  </div>
                  <div className="absolute top-1/2 -left-6 w-10 h-10 bg-gradient-to-r from-green-400 to-orange-500 rounded-2xl flex items-center justify-center animate-orbit-3">
                    <Database className="w-5 h-5 text-white" />
                  </div>
                  <div className="absolute top-1/4 -right-4 w-10 h-10 bg-gradient-to-r from-yellow-400 to-red-500 rounded-2xl flex items-center justify-center animate-float-fast">
                    <Zap className="w-5 h-5 text-white" />
                  </div>
                </div>
                
                {/* Additional floating elements */}
                <div className="absolute -top-8 left-1/4 w-6 h-6 bg-orange-400/60 rounded-full animate-twinkle"></div>
                <div className="absolute -bottom-4 right-1/3 w-4 h-4 bg-red-400/60 rounded-full animate-twinkle" style={{ animationDelay: '1s' }}></div>
                <div className="absolute top-3/4 -left-8 w-5 h-5 bg-amber-400/60 rounded-full animate-twinkle" style={{ animationDelay: '2s' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-fade-in delay-1000">
            <div className="flex flex-col items-center space-y-4 text-gray-400">
              ...
              <div className="relative">
                <div className="w-8 h-12 border-2 border-red-500/50 rounded-full flex justify-center backdrop-blur-sm">
                  <div className="w-1.5 h-4 bg-gradient-to-b from-orange-400 to-red-500 rounded-full mt-2 animate-cosmic-bounce"></div>
                </div>
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400/10 to-red-400/10 rounded-full blur-lg animate-pulse"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-red-500/10 border border-red-500/20 rounded-full px-6 py-3 backdrop-blur-sm mb-8">
              ...
              <span className="text-red-400 text-sm font-medium">Get to know me</span>
            </div>
            ...
            <div className="space-y-8 animate-slide-in-left">
              <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                <p className="text-xl text-white font-medium">
                  I'm a passionate <span className="text-orange-400 font-semibold">B.Tech Information Technology</span> student 
                  at Manipal University Jaipur, driven by the endless possibilities of technology.
                </p>
                <p>
                  With expertise in <span className="text-red-400 font-semibold">Python, Java, C, and C++</span>, 
            ...
            <div className="space-y-6 animate-slide-in-right">
              ...
              <div className="group bg-gradient-to-br from-slate-800/50 to-red-900/20 rounded-3xl p-8 border border-red-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                <div className="flex items-start space-x-4">
                  <div className="w-14 h-14 bg-gradient-to-r from-orange-400 to-amber-500 rounded-2xl flex items-center justify-center group-hover:animate-pulse">
                    <GraduationCap className="w-7 h-7 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-orange-400 mb-2">Education</h3>
                    <p className="font-medium text-lg text-white">B.Tech Information Technology</p>
                    <p className="text-red-300 font-medium">Manipal University Jaipur</p>
              ...
              <div className="group bg-gradient-to-br from-slate-800/50 to-red-900/20 rounded-3xl p-8 border border-red-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                <div className="flex items-start space-x-4">
                  <div className="w-14 h-14 bg-gradient-to-r from-red-400 to-orange-500 rounded-2xl flex items-center justify-center group-hover:animate-pulse">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-orange-300 font-medium">OPM Corporation</p>
              ...
              <div className="group bg-gradient-to-br from-slate-800/50 to-red-900/20 rounded-3xl p-8 border border-red-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                <div className="flex items-start space-x-4">
                  <div className="w-14 h-14 bg-gradient-to-r from-green-400 to-orange-500 rounded-2xl flex items-center justify-center group-hover:animate-pulse">
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-20 animate-fade-in-up">
            <div className="inline-flex items-center space-x-2 bg-red-500/10 border border-red-500/20 rounded-full px-6 py-3 backdrop-blur-sm mb-8">
              ...
              <span className="text-red-400 text-sm font-medium">What I work with</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">
              Tech Arsenal
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                ...
                className="group bg-gradient-to-br from-slate-800/50 to-red-900/20 rounded-3xl p-8 border border-red-500/30 backdrop-blur-sm hover:scale-105 transition-all duration-500 animate-fade-in-up"
              ...
              >
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-orange-400">{category.category}</h3>
                </div>
                <ul className="space-y-3">
                  {category.skills.map((skill, skillIndex) => (
                    <li 
                      key={skill} 
                      className="text-gray-300 hover:text-orange-300 transition-colors duration-300 cursor-pointer flex items-center space-x-2"
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-red-500/20 bg-slate-900/50">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <div className="w-8 h-8 bg-gradient-to-r from-orange-400 to-red-500 rounded-lg flex items-center justify-center">
              <Rocket className="w-5 h-5 text-white" />
            </div>
            <span className="text-xl font-bold bg-gradient-to-r from-orange-400 via-red-400 to-amber-400 bg-clip-text text-transparent">
              Shrimay
            </span>
          </div>
